...
async function buildParamsId () {
  await this.docSchemaParams('paramsId', 'id||Record ID')
}

async function docSchemaGeneral () {
  await buildErrResp.call(this)
  await buildFilter.call(this)
  await buildParamsId.call(this)
  await buildFields.call(this)
}
